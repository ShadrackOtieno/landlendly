    ...
    <AppLayout>
        <div class="relative bg-blue-600 text-white">
            ...
            >
                ...
                <p class="text-xl mb-8">
                    Discover the best rental properties across Kenya
                </p>
                <Link
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="text-center p-6">
                    ...
                    <p class="text-gray-600">
                        Thousands of verified properties across Kenya
                    </p>
                </div>
                <div class="text-center p-6">
                    <div
                ...
                <div class="text-center p-6">
                    ...
                    <h3 class="text-xl font-semibold mb-2">Quick Process</h3>
                    <p class="text-gray-600">
                        Find and rent properties in just a few clicks
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-gray-100 py-16">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                <h2 class="text-3xl font-bold mb-4">Are you a Landlord?</h2>
                <p class="text-xl text-gray-600 mb-8">
                    List your properties and find tenants quickly
                </p>
                <Link
                    :href="route('register')"
